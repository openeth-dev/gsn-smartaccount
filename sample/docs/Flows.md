...
be->user: SMS: click to add (url)
deactivate be
user->+app: click
app->google: authenticate(email)
google-->app: JWT
app->be: getAddDeviceInfo(jwt,url)
