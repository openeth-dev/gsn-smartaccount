...
module.exports = async function (deployer) {
  ...
  await deployer.deploy(SmartAccount, bypassLib.address, { gas: 8e6 }).then(smartAccount =>
    deployer.deploy(SmartAccountFactory, zeroAddress, smartAccount.address, bypassLib.address, { gas: 8e6 })
  )
