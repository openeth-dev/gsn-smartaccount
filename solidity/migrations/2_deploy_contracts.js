...
module.exports = async function (deployer) {
    ...
    await deployer.deploy(VaultFactory, zeroAddress, zeroAddress,{gas:8e6});
    ...
    let gatekeeper = await deployer.deploy(Gatekeeper, zeroAddress, zeroAddress, zeroAddress, {gas:8e6});
